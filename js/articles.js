const articleData = [
    ...
    },
    {
        "title":"Liability",
        "publish":true,
        "body":"Liabilities are commitments to pay others. This usually takes the form of debt. Some examples include but are no limited to car loans, mortgages, personal loans, credit card balances, outstanding bills and student loans. Take a look at debts to learn more about how they work. There are two main catergories, short-term and long-term. A liability that is due in less than a year is a short-term liability, while anything over due beyond a year is long-term."
    },
    {
        "title":"Debt",
        "publish":true,
    ...
    },
    {
        ...
        "publish":true,
        "body":"Income statements explain where the money that comes in is spent. This form is split into an upper and lower sections. The upper section is a list of income that has been accrued. Income can include but is not limited by wage/salary, profit from rentals and business, dividends and gifts. The lower secion records the expenses. Expenses can include but is not limited by taxes, rent/mortgages, insurance, utilities and other bills. Each section includes a total of the entries. By subtracting the expense total from the income total the result is generally refered to as net income. This is income that can be used for extras like saving and investing."
    },
    {
        "title":"Balance Sheet",
        "publish":true,
        "body":"Balance sheets track the financial postion for a certain time period. It is divided into two columns. On the left is a list of assets. The right side lists the liabilities. Each column includes a summation of the entires on the bottom row. The net worth calculation can be calculated with these results."
    },
    {
        "title":"Passive Income",
        "publish":true,
        "body":"When a person has little to no participation in daily operations that produce income it is called passive income. Some examples include but are not limited to a silent investor in a business, recieving dividends and rental income where a third party is managing the property. Passive income is on a sliding scale meaning that the level of effort varies."
    },
    {
